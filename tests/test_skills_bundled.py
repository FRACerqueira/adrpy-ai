...
class TestAdrpySkillIsBundled:
    ...
    def test_it_keeps_the_agent_to_what_the_user_asked(self):
        ...
        for needle in (
            ...
            "Whenever you created a decision or wrote or changed its text",
            "never approve it to make the command work",
            "that is a supersede, not a new decision",
            "Migrated decisions have no status yet",
            "never describe their old status as kept",
            "Never move, rename or delete a file adrpy did not write to get past a refusal",
            "If a pattern the user gave is refused, say why and ask before using another one",
            "there is nothing to ask",
            "Relay every warning",
            "keep the placeholder for the part the user did not give",
            "for `0001-use-x.md`, `N00:04T05`",
