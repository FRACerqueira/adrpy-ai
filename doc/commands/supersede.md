...
| `supersede-write-failed` | The predecessor's own write (marking it Superseded, the FIRST of the two writes) failed -- nothing was written. |
| `supersede-successor-write-failed` | The successor's own write (the SECOND of the two writes) failed -- the predecessor was already committed to Superseded. |
