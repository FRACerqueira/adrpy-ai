...
| `superseded-predecessor-not-found` | This decision's own predecessor (per its filename's supersede suffix) could not be found, or a multi-member family's own back-reference to it is gone -- no write was made. |
