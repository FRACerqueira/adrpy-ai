...
| `file-already-exists` | The new revision's number is already held by a file of this family (any title, header valid or not), or its resulting filename already exists -- data.file names it. |
