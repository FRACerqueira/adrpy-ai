...
* Revised (round 31): the real-filesystem-resolution guard added in the round 30 revision was itself found to have a check-then-use TOCTOU window, confirmed live and reliably winnable -- see the round 31 decision-log entry closing that finding.
