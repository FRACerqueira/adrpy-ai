...
Architectural review (Round 43): the lost update this docstring describes is no longer an installconfig exception but the general rule: adrpy has no concurrency control and one owner runs it at a time (ADR001). The blast-radius clarification stays true.
