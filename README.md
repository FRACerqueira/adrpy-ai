...
| [`log`](https://github.com/FRACerqueira/adrpy-ai/blob/main/doc/commands/log.md) | Writes a decision-log entry -- the lighter-weight sibling of a formal ADR. |
