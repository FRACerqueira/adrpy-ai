...
class CommandError(Exception):
    def __init__(self, code, detail=None, data=None, warnings=None):
        ...
        `warnings` (mechanism-correctness audit): a real side effect
        (an encoding repair, an orphan-temp-file cleanup, a stale-lock
        reclaim, a retried write) can already have happened before this
