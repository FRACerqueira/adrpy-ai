        ...
        "arguments": [
            ...
            },
            {
                ...
                "description": (
                    ...
                    "labels block on any recognized decision, --separator only if a CURRENT-scheme decision "
                    "exists, --migrationpattern only if a LEGACY-scheme decision exists, and for those last "
                    "two this is a PERMANENT block once the scheme it governs has any decision, with no "
                    "migration path) -- or status-or-separator-change-scan-incomplete if that check itself "
                    "can't be completed. This guard's own scan-incomplete check runs BEFORE this command's own "
