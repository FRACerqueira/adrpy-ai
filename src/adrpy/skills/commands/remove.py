...
def describe():
    return {
        ...
        "description": (
            ...
            "skill's own start/end block is truncated or duplicated) is skipped, not deleted, "
            ...
            "one shared doc a stub-mode provider (copilot, agentsmd) points at is removed only once "
            "no remaining stub-mode provider in this same target still references it, reported in "
